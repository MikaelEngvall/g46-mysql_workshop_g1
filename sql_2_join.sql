...
#
# 15: What names of the cities are in the same country as the city with a population of 122199 (including the city itself)
select name from city where countrycode = (select countrycode from city where population = 122199);

#
# 16: What names of the cities are in the same country as the city with a population of 122199 (excluding the city itself)
